...
studentFeeRoute
    .route('/fetch-current-term-fee-payments/:studentId')
...
studentFeeRoute.route('/fetch-fee-payment-details/:feePaymentId').get(validate(feePaymentIdParamSchema), protectRoute, restrict('STUDENT', 'ADMIN'), asyncErrorHandler(fetchFeePaymentDetailsHandler));
