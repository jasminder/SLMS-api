...
adminManageClassRoute.route('/count-students-in-class')
    .get(validate(fetchStudentCountInClassSchema), protectRoute, restrict('TEACHER', 'ADMIN'), asyncErrorHandler(fetchStudentCountInClassHandler));
